...
public enum RoleEnum {
    ...
    ROLE_SPRAVA_RIDIC, ROLE_ZOBRAZIT_ZADOST_VSE, 
    ROLE_SPRAVA_KC_UZIVATELE, ROLE_SPRAVA_ZASTUPU, ROLE_SPRAVA_ZASTUPU_SYNCHRONIZACE, ROLE_MENU_VEDOUCI,
    ROLE_PRESCAS_SCHVALENI, ROLE_POVOLENI_TPC, ROLE_ZAMESTNANEC_TPC,
    ...
    ROLE_SPRAVA_LOKALIT, ROLE_SPRAVA_BUDOV, ROLE_SPRAVA_OBJEDNAVKY_NEVEREJNE, ROLE_SPRAVA_POVOLENI_VJEZDU_VOZIDLA, 
    ROLE_SPRAVA_OBJEDNAVKY_KOREKCE_PO_OBJEDNANI,
    ROLE_SPRAVA_DOCHAZKA, ROLE_SPRAVA_JMENO_KOREKTURA, ROLE_SPRAVA_NAJEMNICI_KARTY, 
    ROLE_SPRAVA_NAVSTEVNI_LISTEK, ROLE_SPRAVA_SLUZEBNI_VOZIDLO, ROLE_SPRAVA_VJEZD_VOZIDLA, 
    ROLE_SPRAVA_VYJEZD_VOZIDLA, ROLE_SPRAVA_VRANTNICE_KAMERY, ROLE_SPRAVA_VRANTNI, ROLE_SPRAVA_VRATNICE, ROLE_VSECHNY_VRATNICE;

    public static RoleEnum getRoleEnum(String value) {
        switch (value) {
            case "ROLE_VSECHNY_VRATNICE":
                return RoleEnum.ROLE_VSECHNY_VRATNICE;
            case "ROLE_SPRAVA_VRATNICE":
                return RoleEnum.ROLE_SPRAVA_VRATNICE;
            case "ROLE_SPRAVA_VRANTNI":
                return RoleEnum.ROLE_SPRAVA_VRANTNI;
            case "ROLE_SPRAVA_VRANTNICE_KAMERY":
                return RoleEnum.ROLE_SPRAVA_VRANTNICE_KAMERY;
            case "ROLE_SPRAVA_VYJEZD_VOZIDLA":
                return RoleEnum.ROLE_SPRAVA_VYJEZD_VOZIDLA;
            case "ROLE_SPRAVA_VJEZD_VOZIDLA":
                return RoleEnum.ROLE_SPRAVA_VJEZD_VOZIDLA;
            case "ROLE_SPRAVA_SLUZEBNI_VOZIDLO":
                return RoleEnum.ROLE_SPRAVA_SLUZEBNI_VOZIDLO;
            case "ROLE_SPRAVA_RIDIC":
                return RoleEnum.ROLE_SPRAVA_RIDIC;
            case "ROLE_SPRAVA_NAVSTEVNI_LISTEK":
                return RoleEnum.ROLE_SPRAVA_NAVSTEVNI_LISTEK;
            case "ROLE_SPRAVA_DOCHAZKA":
                return RoleEnum.ROLE_SPRAVA_DOCHAZKA;
            case "ROLE_SPRAVA_JMENO_KOREKTURA":
                return RoleEnum.ROLE_SPRAVA_JMENO_KOREKTURA;
            case "ROLE_SPRAVA_NAJEMNICI_KARTY":
                return RoleEnum.ROLE_SPRAVA_NAJEMNICI_KARTY;
            ...
            case "ROLE_ZAMESTNANEC_TPC":
                return RoleEnum.ROLE_ZAMESTNANEC_TPC; // určeno pro přístup k vytváření TPC pouze pro učité zaměstance
            ...
            case "ROLE_SPRAVA_POVOLENI_VJEZDU_VOZIDLA":
                return RoleEnum.ROLE_SPRAVA_POVOLENI_VJEZDU_VOZIDLA;
            ...
            case "ROLE_SPRAVA_OBJEDNAVKY_KOREKCE_PO_OBJEDNANI":
                return RoleEnum.ROLE_SPRAVA_OBJEDNAVKY_KOREKCE_PO_OBJEDNANI;
            default:
