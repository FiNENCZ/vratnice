...
import cz.diamo.share.dto.RoleKcDto;
import cz.diamo.share.dto.UzivatelKcDto;
import cz.diamo.share.dto.ZastupSimpleDto;
...
import cz.diamo.share.repository.TmpOpravneniVseRepository;
import cz.diamo.share.repository.TmpOpravneniVyberRepository;
...
public class AuthServices {
    ...
    public AccessTokenResponse loginKeyCloakAdminUser() throws ValidationException, NoSuchMessageException {
        ...
        cfg.setCredentials(credentials);
        // cfg.setRealm(appProperties.getKeycloakRealm());
        cfg.setRealm("master");// musí být master, uživatel není na diamo
        AuthzClient authzClient = AuthzClient.create(cfg);
