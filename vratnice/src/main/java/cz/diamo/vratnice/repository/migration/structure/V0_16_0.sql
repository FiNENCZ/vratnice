...
insert into vratnice.zdrojovy_text (hash, text) values ('COLUMN_NAME_ZAKAZKA','Zakázka');

-- Verze DB
update vratnice.databaze set verze_db = 0, sub_verze_db = 16, cas_zmn = now(), zmenu_provedl = 'pgadmin';