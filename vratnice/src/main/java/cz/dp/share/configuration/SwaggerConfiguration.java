...
public class SwaggerConfiguration {
	...
	public GroupedOpenApi ngOpenApi(OperationCustomizer globalOperationCustomizer) {
		...
		String packagesToscan[] = { "cz.dp.share.controller", "cz.dp.share.websocket",
				"cz.dp." + Constants.BASE_PACKAGE + ".controller",
				"cz.dp." + Constants.BASE_PACKAGE + ".websocket" };
	...
	public GroupedOpenApi restOpenApi(OperationCustomizer globalOperationCustomizer) {
		...
		String packagesToscan[] = { "cz.dp.share.rest.controller",
				"cz.dp." + Constants.BASE_PACKAGE + ".rest.controller" };
